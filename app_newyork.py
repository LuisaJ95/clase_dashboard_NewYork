...
c1.text('Víctimas: ' +str(top_vic_name)+ ',' +str(top_vic_num)+ '%')
...
c2.text('Víctimas: ' +str(top_vic_name)+ ',' +str(top_vic_num)+ '%')
...
c3.text('Víctimas: ' +str(top_vic_name)+ ',' +str(top_vic_num)+ '%')
...
c1.markdown("<h3 style='text-align: center; color: withe;'> ¿Dónde han ocurrido disparos en Nueva York? </h3>", unsafe_allow_html=True)
...
c2.markdown("<h3 style='text-align: center; color: withe;'> ¿A qué horas ocurren disparos en Nueva York? </h3>", unsafe_allow_html=True)
...
st.markdown("<h3 style='text-align: center; color: withe;'> ¿Cómo ha sido la evolución de disparos por barrio? </h3>", unsafe_allow_html=True)
...
# Definir título
c4.markdown("<h3 style='text-align: center; color: withe;'> ¿Qué edad tienen los atacantes? </h3>", unsafe_allow_html=True)
...
# Definir título
c5.markdown("<h3 style='text-align: center; color: withe;'> ¿Qué edad tienen los víctimas? </h3>", unsafe_allow_html=True)
...
# Definir título
c6.markdown("<h3 style='text-align: center; color: withe;'> ¿Cuál es el sexo del atacante? </h3>", unsafe_allow_html=True)
...
# Definir título
c7.markdown("<h3 style='text-align: center; color: withe;'> ¿Cuál es el sexo de la víctima? </h3>", unsafe_allow_html=True)
